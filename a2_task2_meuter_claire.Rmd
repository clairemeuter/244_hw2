...
**Figure 1.** Snout to vent lengths (mm) and body weights (g) for male and female lizards. Female observations are in red, and male observations in blue. The observation points are overlayed with a line representing the fit of the NLS predicted model. 
